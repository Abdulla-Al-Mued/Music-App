...
public class PlayerService extends Service {
    ...
    public void onCreate() {
        ...
        audioAttributes = new com.google.android.exoplayer2.audio.AudioAttributes.Builder()
        ...
        notificationManager = new PlayerNotificationManager.Builder(this, notificationId, channelId)
                ...
                .setPauseActionIconResourceId(R.drawable.ic_skip_previous)
    ...
    PlayerNotificationManager.MediaDescriptionAdapter descriptionAdapter = new PlayerNotificationManager.MediaDescriptionAdapter() {
        ...
        public PendingIntent createCurrentContentIntent(Player player) {
            ...
            return PendingIntent.getActivity(getApplicationContext(), 0, openIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
        }
        ...
        public Bitmap getCurrentLargeIcon(Player player, PlayerNotificationManager.BitmapCallback callback) {
            ...
            //try to creating an imageview on the play then grt its drawable
            ...
            bitmapDrawable = (BitmapDrawable) ContextCompat.getDrawable(getApplicationContext(), R.drawable.sparkle);
